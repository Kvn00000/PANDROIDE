    ...
    void applyMatcap(inout float4 finalColor, inout float3 matcapEmission)
    {
        ...
        blendMatcap(finalColor, float(0.452), float(0), float(0.833), matcap, matcapMask, matcapEmission, float(0.16)
        #ifdef POI_LIGHTING
        , float(0)
        #endif
        #ifdef POI_BLACKLIGHT
        , _BlackLightMaskMatcap
            ...
            blendMatcap(finalColor, float(0), float(0.729), float(0.651), matcap2, matcap2Mask, matcapEmission, float(0)
            #ifdef POI_LIGHTING
            , float(0)
            #endif
            #ifdef POI_BLACKLIGHT
